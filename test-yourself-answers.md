...
API's provide a way for you to directly interact with the application's data that you want to. It allows a 'side-door' effect where you can gather data from the back door rather than needing to wait at the front for someone to get you what you need.
